...
class HashMap:
    ...
    def put(self, key: str, value: object) -> None:
        ...
        # quadratic probing
        while True:
            probe_index = (index + i * i) % self._capacity
            entry = self._buckets[probe_index]

            if entry is None:
                target_index = first_tombstone if first_tombstone is not None else probe_index
    ...
    def resize_table(self, new_capacity: int) -> None:
        ...
        for item in self:
            new_map.put(item.key, item.value)

        # replace current table data
    ...
    def contains_key(self, key: str) -> bool:
        """
        Returns True if the given key exists in the hash map, otherwise False.
        """
    ...
    def __next__(self):
        """
        Return the next item in the hash map, based on teh current location of the iterator.
        """
